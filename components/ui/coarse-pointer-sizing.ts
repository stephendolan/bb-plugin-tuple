...
const HEADER_ICON_BUTTON_BOX_CLASS =
  "size-[28px] rounded-md p-0 max-md:pointer-coarse:size-[36px]";
...
export const COARSE_POINTER_COMPACT_ICON_BUTTON_CLASS =
  "size-7 rounded-md p-0 max-md:pointer-coarse:size-9 [&_svg]:size-3.5 max-md:pointer-coarse:[&_svg]:size-5";

export const COARSE_POINTER_CHILD_ICON_BUTTON_CLASS =
  "size-8 justify-center p-0 max-md:pointer-coarse:size-9 [&>svg]:size-4 max-md:pointer-coarse:[&>svg]:size-5";

export const COARSE_POINTER_TOOLBAR_ACTION_BUTTON_CLASS =
  "border-border hover:bg-state-hover hover:text-foreground text-foreground h-7 rounded-md bg-transparent px-2 text-xs font-medium shadow-none max-md:pointer-coarse:h-9";
...
export const COARSE_POINTER_PROMPT_COMBO_BUTTON_CLASS =
  "border-l-primary-foreground/20 hover:border-l-primary-foreground/30 size-8 rounded-l-none border-l px-0 transition-all max-md:pointer-coarse:size-10";
...
export const COARSE_POINTER_ROW_HEIGHT_CLASS =
  "h-(--bb-sidebar-row-height) max-md:pointer-coarse:h-(--bb-sidebar-row-height-coarse)";

export const COARSE_POINTER_PROVIDER_TAB_SIZE_CLASS =
  "h-7 w-6 max-md:pointer-coarse:size-9";

export const COARSE_POINTER_ROW_ACTION_SIZE_CLASS =
  "size-7 max-md:pointer-coarse:size-9";
